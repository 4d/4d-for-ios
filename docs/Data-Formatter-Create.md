...
![Light mode](assets/en/data-formatter/light-black-and-white.png){:height="36px" width="700px"} 
![Dark mode](assets/en/data-formatter/dark-black-and-white.png) { width: 200px; }
