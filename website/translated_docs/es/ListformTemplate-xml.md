...
In this tutorial, we've covered the basics for creating Android list form templates. Ahora puede crear plantillas simples por su cuenta utilizando los recursos del Proyecto Starter. Espere, ¡Hay más! In the next tutorial, you’ll learn how to build Android detail form templates! Haga clic en **Final Project** abajo para descargar la carpeta que contiene la lista completa de plantillas.
