...
**OBJETIVOS**
Agregue acciones a plantillas de formularios de Lista y formularios detallados.</div> <div markdown="1" class = "prerequisites">
**REQUISITOS PREVIOS**
...
## PASO 1. Descargar el proyecto Starter
