...
El "searchable field" (campo de búsqueda) es opcional.<div markdown="1" class = "tips">
**NOTA**
...
Now that you have an **icon**, a **basic template description** in the manifest.json file, and your **svg file** ... ¡Pasemos a la parte divertida, con Xcode!
