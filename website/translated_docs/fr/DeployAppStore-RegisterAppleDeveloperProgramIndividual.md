...
* Si vous n’avez aucun identifiant Apple, allez à [Etape 2](#step-2-create-your-apple-id)
* Si vous possédez déjà un identifiant Apple, allez à [Étape 3](#step-3-register-as-a-developer)
