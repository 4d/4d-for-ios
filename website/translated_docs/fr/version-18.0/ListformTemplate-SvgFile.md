...
Le "searchable field" (champ de recherche) est facultatif.<div markdown="1" class = "tips">
**NOTE**
...
Now that you have an **icon**, a **basic template description** in the manifest.json file, and your **svg file** ... nous allons passer à la partie amusante, avec Xcode !
