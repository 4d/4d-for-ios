...
* Créer son application dans l’App Store Connect</div> <div markdown="1" class = "prerequisites">
...
*Un identifiant d'application est une chaîne composée de 2 parties servant à identifier une ou plusieurs applications à partir d'une seule équipe de développement. La chaîne est constituée d’un Team ID et d'un Bundle ID, tous deux séparés par un point (.) (ex : TeamID.BundleID).*<div markdown="1" class = "tips">
**NOTE**
...
C’est ici que vous pourrez définir le prix de votre application.<div markdown="1" class = "tips">
**ASTUCES**
