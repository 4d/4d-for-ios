...
**OBJECTIFS**
Installer une application 4D for iOS sur un appareil connecté</div> <div markdown="1" class = "prerequisites">
**CONDITIONS PRÉALABLES**

* Apple Developer Program.
* [Apple configurator 2](https://itunes.apple.com/us/app/apple-configurator-2/id1037126344) installé sur votre Mac pour installer votre application automatiquement (facultatif).</div> <div markdown="1" class = "tips">
**NOTE**
