---
id: version-18.0-creating-data-formatter
title: Créer le format de données
original_id: creating-data-formatter
---

<div markdown="1" class = "objectives">
**OBJECTIFS**
Créer vos premiers formats de données.</div> <div markdown="1" class = "prerequisites">
