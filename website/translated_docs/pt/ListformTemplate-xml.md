...
In this tutorial, we've covered the basics for creating Android list form templates. Você já pode criar seus próprios modelos simples usando os recursos do Starter Project. Mas espere - há mais! In the next tutorial, you’ll learn how to build Android detail form templates! Clique em **Final Project** abaixo para baixar a pasta que contém a lista completa de modelos.
