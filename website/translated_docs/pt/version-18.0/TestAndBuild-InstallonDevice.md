...
**OBJECTIVES**
Instalar uma aplicação 4D for iOS em um aparelho conectado</div> <div markdown="1" class = "prerequisites">
**PREREQUISITES**

* Programa Apple Developer
* [Apple configurator 2](https://itunes.apple.com/us/app/apple-configurator-2/id1037126344) instalado em seu Mac para automatizar a instalação de app (opcional).</div> <div markdown="1" class = "tips">
**NOTA **
