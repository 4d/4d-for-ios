...
* Generate .ipa and manifest files</div> <div markdown="1" class = "prerequisites">
**PREREQUISITES**
...
## SCHRITT 9. Distribution manifest information
