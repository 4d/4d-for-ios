---
id: version-18.0-custom-detailform-templates
title: 詳細画面のテンプレート
original_id: custom-detailform-templates
---
...
<table> <col width="50%"> <col width="50%"> 
  ...
  <div markdown="1" style="text-align: center; margin-top: 40px;">
    <a class="button" style="width: 50%" href="https://github.com/4d-for-ios/form-detail-ClientDetail/releases/latest/download/form-detail-ClientDetail.zip">ダウンロード</a>
  </div></td> 
  ...
  <div markdown="1" style="text-align: center; margin-top: 40px;">
    <a class="button" style="width: 50%" href="https://github.com/4d-for-ios/form-detail-InvoiceDetail/releases/latest/download/form-detail-InvoiceDetail.zip">ダウンロード</a>
