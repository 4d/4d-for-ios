...
<a class="button"
href="https://github.com/4d-go-mobile/tutorial-StarterContactApp/releases/download/0.0.1/tutorial-StarterContactApp.zip">素材プロジェクト</a>
</div>
...
![一般](assets/en/contact-app/Contact-app-android-sdk-download.png)
