...
<a class="button" style="width: 50%; font-size: 11px" href="https://github.com/4d-for-ios/formatter-IntToImage/releases/latest/download/formatter-IntToImage.zip">ダウンロード</a>
