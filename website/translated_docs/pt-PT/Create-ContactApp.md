...
Vamos começar com uma estrutura muito simples usando uma única tabela. Em 4D, vá para **New > Mobile project**. assets/en/en/ Give your project a name and click **Create**.
